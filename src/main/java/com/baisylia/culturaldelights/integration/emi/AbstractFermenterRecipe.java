...
public abstract class AbstractFermenterRecipe implements EmiRecipe {
    public final static ResourceLocation TEXTURE = new ResourceLocation(CulturalDelights.MOD_ID, "textures/gui/fermenter_gui_jei.png");
    ...
    public AbstractFermenterRecipe(ResourceLocation id, List<EmiIngredient> ingredients, ItemStack resultItem, int cookTime) {
        this.id = id;
