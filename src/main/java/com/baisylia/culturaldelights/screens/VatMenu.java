...
public class VatMenu extends AbstractContainerMenu {
    ...
    private final VatBlockEntity blockEntity;
    private final Level level;
    private final ContainerData data;

    public VatMenu(int pContainerId, Inventory inv, RegistryFriendlyByteBuf extraData) {
        this(pContainerId, inv, inv.player.level().getBlockEntity(extraData.readBlockPos()), new SimpleContainerData(3));
    }

    public VatMenu(int pContainerId, Inventory inv, BlockEntity entity, ContainerData data) {
        super(ModMenuTypes.VAT_MENU.get(), pContainerId);
        checkContainerSize(inv, 8);
        this.blockEntity = ((VatBlockEntity) entity);
    ...
    public VatTemperature getTemperature() {
        return VatTemperature.values()[data.get(2)];
    }
